...
using QuickCode.MyecommerceDemo.Portal.Mapper;
using QuickCode.MyecommerceDemo.Portal.ViewEngines;
using QuickCode.MyecommerceDemo.Common.Middleware;
using QuickCode.MyecommerceDemo.Portal.Middleware;

namespace QuickCode.MyecommerceDemo.Portal
{
