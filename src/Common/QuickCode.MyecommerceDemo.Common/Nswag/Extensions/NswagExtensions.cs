...
namespace QuickCode.MyecommerceDemo.Common.Nswag.Extensions
{
    public static class NswagExtensions
    {
        ...
        public static void AddNswagServiceClient(this IServiceCollection services, IConfiguration configuration,
            ...
            string namespacePrefix = "QuickCode.MyecommerceDemo.Common.Nswag.Clients.")
        {
        ...
        public static void AddServiceClient(this IServiceCollection services, IConfiguration configuration,
            Type type, bool addRetryHandler = false,
            string namespacePrefix = "QuickCode.MyecommerceDemo.")
        {
        ...
        public static void AddNswagServiceClient(this IServiceCollection services, IConfiguration configuration,
            Assembly assembly, bool addRetryHandler=false, string namespacePrefix = "QuickCode.MyecommerceDemo.Common.Nswag.Clients.")
        {
